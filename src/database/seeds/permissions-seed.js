...
const seed = async () => {
  ...
  try {
    ...
    const permissionsData = [
      ...
      {
        permissionCode: 'PAYROLL_SLIP_READ',
        description: 'Xem phiếu lương',
        module: 'Payroll',
      },
      {
        permissionCode: 'PAYROLL_SLIP_CREATE',
      ...
      {
        permissionCode: 'REQUEST_GROUP_APPROVAL_CONFIG',
        description: 'Cấu hình phê duyệt nhóm yêu cầu',
        module: 'Request',
      },
    ...
    if (roleMap['MANAGER']) {
      const managerPermissions = [
        ...
        'PENALTY_READ_OWN',
        'USER_READ',
        'USER_ACTION_LOG_READ',
        'USER_ACTION_LOG_EXPORT',
        'AI_CONFIGURATION_READ',
        'AI_PROMPT_READ',
    ...
    if (roleMap['HR']) {
      const hrPermissions = [
        'ATTENDANCE_BLOCKING_CONFIG_READ',
        'ATTENDANCE_BLOCKING_CONFIG_CREATE',
        'ATTENDANCE_BLOCKING_CONFIG_UPDATE',
        'ATTENDANCE_BLOCKING_CONFIG_DELETE',
        'ATTENDANCE_SECURITY_CONFIG_READ',
        'ATTENDANCE_SECURITY_CONFIG_UPDATE',
