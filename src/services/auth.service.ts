...
import { RegisterDto, ChangePasswordDto } from '../models/dto/auth';
import { UserEntity } from '../models/entities/user.entity';
import { hashPassword, comparePassword } from '../common/utils';
import { AppMessages } from '../common/constants';
import { UnauthorizedException, BadRequestException, ConflictException, NotFoundException } from '../common/exceptions';
...
export class AuthService {
    ...
    private async generateTokens(user: UserEntity) {
        ...
        const [accessToken, refreshToken] = await Promise.all([
            ...
            jwt.sign(payload, refreshSecret, { expiresIn: refreshExpiresIn as any }),
        ]);
