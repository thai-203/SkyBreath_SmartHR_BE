...
import {
  ...
  UpdateRequestTypePolicyDto,
} from '../models/dto/request-types/index.js';
...
router.get(
  '/',
  authMiddleware,
  permissionsMiddleware(['REQUEST_TYPE_READ', 'REQUEST_READ_OWN']),
  requestTypesController.findAll,
);
...
router.get(
  '/:id',
  authMiddleware,
  permissionsMiddleware('REQUEST_TYPE_READ'),
  requestTypesController.findById,
);
router.post(
  '/',
  authMiddleware,
...
router.patch(
  '/:id/policy',
  authMiddleware,
  permissionsMiddleware('REQUEST_TYPE_POLICY_CONFIG'),
...
router.delete(
  '/:id',
  authMiddleware,
  permissionsMiddleware('REQUEST_TYPE_DELETE'),
  requestTypesController.remove,
);
