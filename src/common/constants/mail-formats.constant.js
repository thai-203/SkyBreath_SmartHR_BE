        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding:30px;">
              ...
              <p style="color:#555555; line-height:1.6;">
                Bạn được yêu cầu <b>đặt lại mật khẩu</b> cho tài khoản SkyBreathHRM.
              </p>

              <!-- BOX CONTENT -->
              <div style="background:#f1f5ff; border-left:4px solid #0d6efd; padding:16px; margin:20px 0;">
                <p style="margin:0; color:#333;">
                  🔐 Link đặt lại mật khẩu này sẽ vô hiệu sau khi bạn sử dụng nó.
                </p>
              </div>
              ...
              <p style="color:#777777; font-size:14px;">
                Vui lòng thực hiện yêu cầu này để tiếp tục đăng nhập vào hệ thống. Nếu bạn không thực hiện yêu cầu này, vui lòng liên hệ với quản trị viên của bạn.
              </p>
...
export { forgotPasswordEmailTemplate, ResetPasswordEmailTemplate };
