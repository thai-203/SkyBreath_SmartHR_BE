...
export class FaceRecognitionConfigController {
  ...
  getConfig = async (req, res, next) => {
    try {
      ...
      ResponseUtil.sendResponse(res, AppMessages.Success.RETRIEVED, config);
    } catch (error) {
      next(error);
    }
  };
  ...
  updateConfig = async (req, res, next) => {
    try {
      ...
      ResponseUtil.sendResponse(res, AppMessages.Success.UPDATED, updated);
    } catch (error) {
      next(error);
    }
  };
  ...
  resetToDefaults = async (req, res, next) => {
    try {
      ...
      ResponseUtil.sendResponse(res, AppMessages.Success.DEFAULT, result);
    } catch (error) {
      next(error);
    }
  };
