...
export class AttendanceAllowedIpController {
  ...
  list = async (req, res, next) => {
    try {
      ...
      ResponseUtil.sendResponse(res, AppMessages.Success.RETRIEVED_ALL, items);
    } catch (error) {
      next(error);
    }
  };
  ...
  create = async (req, res, next) => {
    try {
      ...
      ResponseUtil.sendResponse(res, AppMessages.Success.CREATED, item);
    } catch (error) {
      next(error);
    }
  };
  ...
  delete = async (req, res, next) => {
    try {
      ...
      ResponseUtil.sendResponse(res, AppMessages.Success.DELETED, null);
    } catch (error) {
      next(error);
    }
  };
