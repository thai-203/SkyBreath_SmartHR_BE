...
import { departmentTransfersRoutes } from './routes/department-transfers.routes.js';
...
import payrollConfigRoutes from './routes/payroll-config.routes.js';
...
app.use(`/${API_PREFIX}/${API_VERSION}/department-transfers`, departmentTransfersRoutes);
